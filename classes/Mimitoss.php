<?php
class Mimitoss extends Pokemon {
    ...
    public static $idEvolution = 63;
    public static $nameEvolution = 'Aéromite';
    public static $popularity = 10;
    public static $babyId = 62;
    ...
    public function move($fenceId){
        ...
        $state = $this->getNameSpecies(). " crache un nuage de poison";
        }
        return $state;
    }
}
