...
class Goupix extends Pokemon {
    ...
    public static $minHeight = 25;
    public static $maxWeight = 10;
    public static $maxHeight = 60;
    public static $lifeExpectancy = 12;
    public static $ageEvolution = 8;
    public static $idEvolution = 52;
    public static $nameEvolution = 'Feunard';
    public static $popularity = 18;
    public static $babyId = 51;
    ...
    public function move($fenceId){
        ...
        $state = $this->getNameSpecies(). " attends docilement";
        }
        return $state;
    }
}
