<?php
class Minidraco extends Pokemon {
    ...
    public static $maxHeight = 180;
    public static $lifeExpectancy = 12;
    public static $ageEvolution = 8;
    public static $idEvolution = 39;
    public static $nameEvolution = 'Draco';
    ...
    public function move($fenceId){
        ...
        $state = $this->getNameSpecies(). " se déplace gracieusement";
        }
        return $state;
    }
}
