<?php
    class Sulfura extends Pokemon {
        ...
        public static $minWeight = 60;
        public static $minHeight = 200;
        public static $maxWeight = 60;
        public static $maxHeight = 200;
        public static $lifeExpectancy = 10000;
        public static $popularity = 80;
        public static $babyId = 37;
        ...
        public function move($fenceId){
            ...
            $state = $this->getNameSpecies(). " dégage une chaleur infernale";
            }
            return $state;
        }
    }
