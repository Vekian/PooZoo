<?php
    class Artikodin extends Pokemon {
        ...
        public static $minWeight = 55;
        public static $minHeight = 170;
        public static $maxWeight = 55;
        public static $maxHeight = 170;
        public static $lifeExpectancy = 10000;
        public static $popularity = 80;
        public static $babyId = 35;
        public static $legendary = true;
        ...
        public function move($fenceId){
            ...
            $state = $this->getNameSpecies(). " génère un blizzard dans son envol";
            }
            return $state;
        }
    }
