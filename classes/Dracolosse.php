...
class Dracolosse extends Pokemon {
    ...
    public static $minWeight = 50;
    public static $minHeight = 190;
    public static $maxWeight = 210;
    public static $maxHeight = 230;
    public static $lifeExpectancy = 30;
    public static $popularity = 60;
    public static $babyId = 38;
    ...
    public function move($fenceId){
        ...
        $state = $this->getNameSpecies(). " fait trembler le sol à chacun de ses pas";
        }
        return $state;
    }
}
