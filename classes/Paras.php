...
class Paras extends Pokemon {
    ...
    public static $minHeight = 18;
    public static $maxWeight = 5;
    public static $maxHeight = 30;
    public static $lifeExpectancy = 12;
    public static $ageEvolution = 8;
    public static $idEvolution = 61;
    public static $nameEvolution = 'Parasect';
    public static $popularity = 10;
    public static $babyId = 60;
    ...
    public function move($fenceId){
        ...
        $state = $this->getNameSpecies(). " se cache parmi les champignons";
        }
        return $state;
    }
}
