...
class Mélofée extends Pokemon {
    ...
    public static $minWeight = 3;
    public static $minHeight = 20;
    public static $maxWeight = 8;
    public static $maxHeight = 60;
    public static $lifeExpectancy = 12;
    public static $ageEvolution = 8;
    public static $idEvolution = 50;
    public static $nameEvolution = 'Mélodelfe';
    public static $popularity = 10;
    public static $babyId = 49;
    ...
    public function move($fenceId){
        ...
        $state = $this->getNameSpecies(). " agite étrangement ses doigts";
        }
        return $state;
    }
}
