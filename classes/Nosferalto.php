<?php
class Nosferalto extends Pokemon {
    ...
    public static $minHeight = 45;
    public static $maxWeight = 55;
    public static $maxHeight = 160;
    public static $lifeExpectancy = 18;
    public static $popularity = 25;
    public static $babyId = 55;
    ...
    public function move($fenceId){
        ...
        $state = $this->getNameSpecies(). " vole frénétiquement";
        }
        return $state;
    }
}
