<?php
class Magicarpe extends Pokemon {
    ...
    public static $maxHeight = 90;
    public static $lifeExpectancy = 12;
    public static $ageEvolution = 10;
    public static $idEvolution = 69;
    public static $nameEvolution = 'Leviator';
    public static $popularity = 1;
    public static $babyId = 68;
    ...
    public function move($fenceId){
        ...
        $state = $this->getNameSpecies(). " frétille comme un ahuri";
        }
        return $state;
    }
}
