<?php
    class Electhor extends Pokemon {
        ...
        public function move($fenceId){
            ...
            $state = $this->getNameSpecies(). " fait gronder le tonnerre";
            }
            return $state;
        }
    }
