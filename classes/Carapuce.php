...
class Carapuce extends Pokemon {
    ...
    public static $minHeight = 10;
    public static $maxWeight = 9;
    public static $maxHeight = 50;
    public static $lifeExpectancy = 10;
    public static $ageEvolution = 5;
    public static $idEvolution = 8;
    public static $nameEvolution = 'Carabaffe';
    public static $popularity = 10;
    public static $babyId = 5;
    ...
    public function move($fenceId){
        ...
        $state = $this->getNameSpecies(). " nage dans l'aquarium.";
    }
        return $state;
    }
}
