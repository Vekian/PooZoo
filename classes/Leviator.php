...
class Leviator extends Pokemon {
    ...
    public static $maxWeight = 235;
    public static $maxHeight = 600;
    public static $lifeExpectancy = 24;
    public static $popularity = 50;
    ...
    public function move($fenceId){
        ...
        $state = $this->getNameSpecies(). " nage avec férocité";
        }
        return $state;
    }
}
