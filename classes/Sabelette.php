<?php
    class Sabelette extends Pokemon {
        ...
        public static $maxWeight = 12;
        public static $maxHeight = 60;
        public static $lifeExpectancy = 10;
        public static $ageEvolution = 5;
        public static $idEvolution = 42;
        public static $nameEvolution = 'Sablaireau';
        public static $popularity = 10;
        public static $babyId = 41;
        ...
        public function move($fenceId){
            ...
            $state = $this->getNameSpecies(). " creuse la terre";
            }
            return $state;
        }
    }
