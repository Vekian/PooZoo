<?php
    class Nidoking extends Pokemon {
        ...
        public static $minWeight = 30;
        public static $minHeight = 65;
        public static $maxWeight = 62;
        public static $maxHeight = 140;
        ...
        public function move($fenceId){
            ...
            $state = $this->getNameSpecies(). " s'élance furieusement";
            }
            return $state;
        }
    }
