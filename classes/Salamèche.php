<?php
    class Salamèche extends Pokemon {
        ...
        public static $idEvolution = 10;
        public static $nameEvolution = 'Reptincel';
        public static $popularity = 10;
        public static $babyId = 6;
        ...
        public function move($fenceId){
                ...
                $state = $this->getNameSpecies(). " crache des flammes ";
                    }
                return $state;
            }
    }
