<?php
class Taupiqueur extends Pokemon {
    ...
    public static $minHeight = 8;
    public static $maxWeight = 1;
    public static $maxHeight = 20;
    public static $lifeExpectancy = 12;
    public static $ageEvolution = 8;
    public static $idEvolution = 65;
    public static $nameEvolution = 'Triopiqueur';
    public static $popularity = 15;
    public static $babyId = 64;
    ...
    public function move($fenceId){
        ...
        $state = $this->getNameSpecies(). " creuse profondément le sol";
        }
        return $state;
    }
}
