<?php
    class Nidorino extends Pokemon {
        ...
        public static $minWeight = 11;
        public static $minHeight = 55;
        public static $maxWeight = 20;
        public static $maxHeight = 90;
        public static $lifeExpectancy = 15;
        public static $ageEvolution = 10;
        public static $idEvolution = 45;
        public static $nameEvolution = 'Nidoking';
        public static $popularity = 20;
        public static $babyId = 43;
        ...
        public function move($fenceId){
            ...
            $state = $this->getNameSpecies(). " gambade joyeusement";
            }
            return $state;
        }
    }
